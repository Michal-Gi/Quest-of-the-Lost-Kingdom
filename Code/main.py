...
running = True
gracz = player.Player(pos=(100,200), groups=character_sprite_group, speed=2, animation_speed=0.2, scale=0.75)
...
enemy = basicenemy.BasicEnemy(pos=(100, 300), groups=character_sprite_group, speed=1, chase_range=80, scale=0.75, animation_speed=0.2, player=gracz)
enemy1 = basicenemy.BasicEnemy(pos=(100, 330), groups=character_sprite_group, speed=1, chase_range=80, scale=0.75, animation_speed=0.2, player=gracz)
enemy2 = basicenemy.BasicEnemy(pos=(100, 360), groups=character_sprite_group, speed=1, chase_range=80, scale=0.75, animation_speed=0.2, player=gracz)
